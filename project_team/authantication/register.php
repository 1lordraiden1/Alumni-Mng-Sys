...
$error='';
if(isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['phone'])&&isset($_POST['email']) && isset($_POST['age']) && isset($_POST['specialist'])&&isset($_FILES['fileToUpload'])&& $_FILES['fileToUpload']["size"]!=0 ){// if send or not
    if(!empty($_POST['first_name']) && !empty($_POST['last_name']) && !empty($_POST['phone'])&&!empty($_POST['email']) && !empty($_POST['age']) && !empty($_POST['specialist'])){
        $user=new User;
        ...
        $user->speialist=$_POST["specialist"];
        $user->age=$_POST["age"];
        ...
        if(move_uploaded_file($img['tmp_name'],$location))
        {
            ...
            }else if($_SESSION["speialist"]=="alumin"){
                header("location: ../alumni/index.php");
             }else if( $_SESSION["speialist"]=="student"){
    ...
    ?>
              <form id="formAuthentication" class="mb-3"  method="POST"  enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-control"name="specialist" id="cars">
                ...
                <div class="mb-3">
                  ...
                  <input  class="form-control" id="email" type="file" name="fileToUpload" placeholder="edit profile" />
                </div>
                <div class="mb-3">
