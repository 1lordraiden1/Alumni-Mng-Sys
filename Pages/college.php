...
$col = new college;
$cols = $col->GetColleges();

$links = array("FCAIHelwan.docx","FECairo.docx");
?>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tr>
                            <td>
                              <span class="pl-2"><?php echo $c['college_id'] ?></span>
                            </td>
                            <td> <?php echo $c['college_name'] ?> </td>
                            <td>  <?php echo $c['college_location'] ?> </td>
